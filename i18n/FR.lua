...
TI.locale.templates["new_veteran"] =                                    "<<1>> <<2>> atteint <<3>> CP"
...
TI.locale.settings["TGI_SettingsAnnounce"] =                            "Voir les Annonces"
...
TI.locale.settings["TGI_SettingsAnnounceDisplayMoveable"] =             "Débloquez Annonce fenêtre"
